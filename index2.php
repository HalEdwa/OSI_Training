...
<html >
	...
	<body>
		<?php
			function initial(){
					   echo '<p>Fill in your contacts information then study and take the quiz for all for sections.</p> ';
					}
					function ppandg(){
						echo '
							<div class="row">
					...
					function whs(){
						echo '
							<div class="row">
								<div class="column">
									<br> 
									<iframe class = "main" src="https://docs.google.com/presentation/d/19V-N1_3Mj3IXxOOgaICCuIemwoluuoRWS-UEBl7VONw/embed?start=false&loop=false&delayms=60000" frameborder="0" width="725" height="550" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
									<br><br>
								</div>
								<div class="column, right">
									<br><br>
					...
					function whsQuizMark() {
						if ($_POST["q1"] == "C" & $_POST["q2"] == "B" & $_POST["q3"] == "A" & $_POST["q4"] == "A" & $_POST["q5"] == "D" & $_POST["q6"] == "A" & $_POST["q7"] == "B") {
							...
							echo '
							<p>You Passed WHS. You have completed training. <br><p>
							';
						} else {
							echo '<form class = "left" action="/index2.php">
							<p>  You Failed <br>
